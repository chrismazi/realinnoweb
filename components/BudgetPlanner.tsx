...
const Icons = {
    ...
    Kwinezeza: (props: any) => <svg {...props} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M14.828 14.828a4 4 0 01-5.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>,
...
const getIcon = (name: string, className: string = "w-5 h-5") => {
    switch (name) {
        ...
        case 'kwinezeza': return <Icons.Kwinezeza className={className} />;
...
const expenseCategories: BudgetCategory[] = [
    ...
    { id: '4', name: 'Entertainment', type: 'expense', spent: 0, limit: 300, color: '#ec4899', icon: 'kwinezeza' },
                    ...
                    <div className="bg-white dark:bg-slate-950 w-full max-w-lg rounded-t-[2.5rem] p-6 pb-28 shadow-2xl animate-slide-up transition-colors border-t border-white/10 relative z-10 max-h-[calc(100vh-7rem)] overflow-y-auto">
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" value={txTitle} onChange={e => setTxTitle(e.target.value)} placeholder="urugero: Kugura ibiribwa" className="w-full bg-slate-50 dark:bg-slate-900 rounded-3xl py-4 px-6 font-bold text-slate-900 dark:text-white outline-none focus:ring-2 focus:ring-teal-500 transition-all border border-slate-100 dark:border-slate-800" />
                            </div>
                            <div>
