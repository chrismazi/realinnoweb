          ...
          {view === AuthState.SIGNUP && (
            <label className="flex items-start gap-3 cursor-pointer group">
              ...
              <span className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
                I agree to the{' '}
                <button type="button" className="text-brand font-semibold hover:underline">Terms of Service</button>
                {' '}and{' '}
                <button type="button" className="text-brand font-semibold hover:underline">Privacy Policy</button>
              </span>
            </label>
          )}
